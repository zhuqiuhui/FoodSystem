...
<body>
    ...
    <div class="formtitle"><span>用户修改</span></div>
    ...
    <c:if test="${!empty requestScope.msg}">
		...
		<tr>
			...
			<input type="button" border="1 solid" value="删除" onclick="javascript:window.location='Users/delete?bianhao=${user.userId}';"> 
			<input type="submit" border="1 solid" value="保存修改">
			</td>
			</form>
		</tr>
        </c:forEach> 
